#!/usr/bin/env bash
# seed-kendrick-billie.sh — Generate nuggets + companions for Kendrick Lamar and Billie Eilish.
...
declare -a SLUGS=("kendrick" "billie")
declare -a ARTISTS=("Kendrick Lamar" "Billie Eilish")
declare -a TITLES=("HUMBLE." "bad guy")
declare -a ALBUMS=("DAMN." "WHEN WE ALL FALL ASLEEP, WHERE DO WE GO?")
declare -a TRACK_IDS=(
  "real::Kendrick Lamar::HUMBLE.::DAMN.::spotify:track:7KXjTSCq5nL1LoYtL7XAwS"
  "real::Billie Eilish::bad guy::WHEN WE ALL FALL ASLEEP, WHERE DO WE GO?::spotify:track:2Fxmhks0bxGSBdJ92vM42m"
)
...
echo ""
echo "========================================"
echo "  Done! Seed data saved to $DATA_DIR"
echo "========================================"
