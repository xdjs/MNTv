...
export const nuggets: Nugget[] = [
  // Daft Punk — Around the World
  // Daft Punk — Around the World
  { id: "n-dp-1", trackId: "daft-punk-around-the-world", timestampSec: 8, durationMs: 7000, text: "The entire track uses only one vocal phrase — repeated 144 times. The repetition is the point.", kind: "artist", sourceId: "src-dp-art" },
  { id: "n-dp-2", trackId: "daft-punk-around-the-world", timestampSec: 45, durationMs: 7000, text: "Thomas Bangalter recorded this in his bedroom with a Roland TR-909 — the same drum machine behind most Chicago house.", kind: "track", sourceId: "src-dp-yt" },
  { id: "n-dp-3", trackId: "daft-punk-around-the-world", timestampSec: 90, durationMs: 6000, text: "🎧 Listen for the bass pattern shifting subtly here — Bangalter wanted 'primal house, nothing more.'", kind: "discovery", listenFor: true, relatedMomentSec: 95, sourceId: "src-dp-int" },
  // Radiohead — Everything in Its Right Place
  { id: "n-rh-1", trackId: "radiohead-everything", timestampSec: 50, durationMs: 6000, text: "Thom Yorke's vocals are fed through an Ensoniq DP/4 — burying the words was intentional.", kind: "artist", sourceId: "src-rh-yt" },
  { id: "n-rh-2", trackId: "radiohead-everything", timestampSec: 126, durationMs: 5500, text: "The band refused to rehearse Kid A's songs before recording. This was the first track cut.", kind: "track", sourceId: "src-rh-art" },
  { id: "n-rh-3", trackId: "radiohead-everything", timestampSec: 196, durationMs: 6000, text: "🎧 Listen for the glitchy vocal chops — Jonny realized 'guitars weren't the only way to express dread.'", kind: "discovery", listenFor: true, relatedMomentSec: 201, sourceId: "src-rh-int" },
  // Pink Floyd — Money
  { id: "n-pf-1", trackId: "pink-floyd-money", timestampSec: 77, durationMs: 6000, text: "The cash register loop was made from real coins and tills — Roger Waters taped them in his garden shed.", kind: "artist", sourceId: "src-pf-yt" },
  { id: "n-pf-2", trackId: "pink-floyd-money", timestampSec: 192, durationMs: 5500, text: "Dark Side of the Moon spent 937 weeks on the Billboard 200. That's nearly 18 years.", kind: "track", sourceId: "src-pf-art" },
  { id: "n-pf-3", trackId: "pink-floyd-money", timestampSec: 301, durationMs: 6000, text: "🎧 Listen for the 7/4 time signature — Nick Mason says it 'wasn't intentional, it just felt right.'", kind: "discovery", listenFor: true, relatedMomentSec: 306, sourceId: "src-pf-int" },
  // Björk — Army of Me
  { id: "n-bj-1", trackId: "bjork-army-of-me", timestampSec: 45, durationMs: 6000, text: "Björk mailed beats to collaborators on cassette tape from Reykjavík. The isolation was part of the sound.", kind: "artist", sourceId: "src-bj-yt" },
  { id: "n-bj-2", trackId: "bjork-army-of-me", timestampSec: 112, durationMs: 5500, text: "Post turned vulnerability into a sonic weapon — critics called it 'pop from another planet.'", kind: "track", sourceId: "src-bj-art" },
  { id: "n-bj-3", trackId: "bjork-army-of-me", timestampSec: 174, durationMs: 6000, text: "🎧 Listen for that massive bass — Björk wanted it to 'feel like being inside a tank.'", kind: "discovery", listenFor: true, relatedMomentSec: 179, sourceId: "src-bj-int" },
  // Talking Heads — Once in a Lifetime
  { id: "n-th-1", trackId: "talking-heads-once", timestampSec: 53, durationMs: 6000, text: "Brian Eno made the band play without knowing what song they were building. Structure came last.", kind: "artist", sourceId: "src-th-yt" },
  { id: "n-th-2", trackId: "talking-heads-once", timestampSec: 132, durationMs: 5500, text: "Byrne's 'same as it ever was' was improvised — he was channeling televangelists he'd been watching.", kind: "track", sourceId: "src-th-art" },
  { id: "n-th-3", trackId: "talking-heads-once", timestampSec: 206, durationMs: 6000, text: "🎧 Listen for the polyrhythmic layers — the band was 'falling apart, but the music never sounded more together.'", kind: "discovery", listenFor: true, relatedMomentSec: 211, sourceId: "src-th-int" },
  // Kraftwerk — Autobahn
  { id: "n-kw-1", trackId: "kraftwerk-autobahn", timestampSec: 54, durationMs: 6000, text: "Kraftwerk built custom instruments because nothing commercial could produce the sounds they imagined.", kind: "artist", sourceId: "src-kw-yt" },
  { id: "n-kw-2", trackId: "kraftwerk-autobahn", timestampSec: 135, durationMs: 5500, text: "The full track is 22 minutes. U.S. radio edited it to 3 — and it still charted at #25.", kind: "track", sourceId: "src-kw-art" },
  { id: "n-kw-3", trackId: "kraftwerk-autobahn", timestampSec: 211, durationMs: 6000, text: "🎧 Listen for the synthesizer melody here — Schneider said 'We don't play instruments. We play the studio.'", kind: "discovery", listenFor: true, relatedMomentSec: 216, sourceId: "src-kw-int" },
  // Aphex Twin — Xtal
  { id: "n-at-1", trackId: "aphex-twin-xtal", timestampSec: 58, durationMs: 6000, text: "Richard D. James recorded Xtal on equipment he soldered together himself — at age 14.", kind: "artist", sourceId: "src-at-yt" },
  { id: "n-at-2", trackId: "aphex-twin-xtal", timestampSec: 145, durationMs: 5500, text: "SAW 85–92 'sounds like dreaming in a language you almost understand' — it defined ambient techno.", kind: "track", sourceId: "src-at-art" },
  { id: "n-at-3", trackId: "aphex-twin-xtal", timestampSec: 227, durationMs: 6000, text: "🎧 Listen for those ghostly vocal pads — the sounds just 'appeared' from his DIY circuits.", kind: "discovery", listenFor: true, relatedMomentSec: 232, sourceId: "src-at-int" },
  // David Bowie — Heroes
  { id: "n-db-1", trackId: "david-bowie-heroes", timestampSec: 74, durationMs: 6000, text: "Bowie could see the Berlin Wall from the studio window. A couple kissing beneath it inspired the lyrics.", kind: "artist", sourceId: "src-db-yt" },
  { id: "n-db-2", trackId: "david-bowie-heroes", timestampSec: 185, durationMs: 5500, text: "Eno's Oblique Strategies cards guided every creative decision — random constraints as a creative engine.", kind: "track", sourceId: "src-db-art" },
  { id: "n-db-3", trackId: "david-bowie-heroes", timestampSec: 291, durationMs: 6000, text: "🎧 Listen for the massive guitar wall — Visconti's 3-mic gating technique created that legendary sound.", kind: "discovery", listenFor: true, relatedMomentSec: 296, sourceId: "src-db-int" },
  // Portishead — Wandering Star
  { id: "n-ph-1", trackId: "portishead-wandering", timestampSec: 58, durationMs: 6000, text: "Geoff Barrow sampled obscure 60s spy film soundtracks to build Dummy's sonic palette.", kind: "artist", sourceId: "src-ph-yt" },
  { id: "n-ph-2", trackId: "portishead-wandering", timestampSec: 146, durationMs: 5500, text: "Beth Gibbons recorded vocals in near darkness — the band needed the right emotional atmosphere.", kind: "track", sourceId: "src-ph-art" },
  { id: "n-ph-3", trackId: "portishead-wandering", timestampSec: 228, durationMs: 6000, text: "🎧 Listen for those crackling samples — Barrow was 'terrified someone would recognize them. Nobody did.'", kind: "discovery", listenFor: true, relatedMomentSec: 233, sourceId: "src-ph-int" },
  // Steely Dan — Aja
  { id: "n-sd-1", trackId: "steely-dan-aja", timestampSec: 95, durationMs: 6000, text: "Fagen and Becker auditioned 7 drummers for this track before Steve Gadd walked in and nailed it.", kind: "artist", sourceId: "src-sd-yt" },
  { id: "n-sd-2", trackId: "steely-dan-aja", timestampSec: 238, durationMs: 5500, text: "The album cost $1 million in 1977 — roughly $5 million today. Every single note was scrutinized.", kind: "track", sourceId: "src-sd-art" },
  { id: "n-sd-3", trackId: "steely-dan-aja", timestampSec: 376, durationMs: 6000, text: "🎧 Listen for Gadd's legendary drum solo — he played it once. 'That's the one,' they said.", kind: "discovery", listenFor: true, relatedMomentSec: 381, sourceId: "src-sd-int" },
  // Daft Punk — One More Time
  { id: "n-dp-omt-1", trackId: "daft-punk-one-more-time", timestampSec: 64, durationMs: 6000, text: "Romanthony's vocal was intentionally compressed to the point of distortion — Daft Punk wanted it to sound 'damaged but joyful.'", kind: "artist", sourceId: "src-dp-omt-yt" },
  { id: "n-dp-omt-2", trackId: "daft-punk-one-more-time", timestampSec: 160, durationMs: 5500, text: "Discovery was inspired by childhood memories of Saturday morning cartoons — they even made an anime film for it.", kind: "track", sourceId: "src-dp-omt-art" },
  { id: "n-dp-omt-3", trackId: "daft-punk-one-more-time", timestampSec: 256, durationMs: 6000, text: "🎧 Listen for the filtered vocal breakdown here — Thomas said 'the vocoder is another instrument, not a gimmick.'", kind: "discovery", listenFor: true, relatedMomentSec: 261, sourceId: "src-dp-omt-int" },
  // Daft Punk — Get Lucky
  { id: "n-dp-gl-1", trackId: "daft-punk-get-lucky", timestampSec: 74, durationMs: 6000, text: "Nile Rodgers played the guitar riff hundreds of times — they comped the final version from dozens of takes.", kind: "artist", sourceId: "src-dp-gl-yt" },
  { id: "n-dp-gl-2", trackId: "daft-punk-get-lucky", timestampSec: 184, durationMs: 5500, text: "Random Access Memories was recorded entirely with live musicians — a deliberate rejection of the laptop era.", kind: "track", sourceId: "src-dp-gl-art" },
  { id: "n-dp-gl-3", trackId: "daft-punk-get-lucky", timestampSec: 295, durationMs: 6000, text: "🎧 Listen for Pharrell's vocal ad-libs — most were first takes that the duo refused to re-record.", kind: "discovery", listenFor: true, relatedMomentSec: 300, sourceId: "src-dp-gl-int" },
  // Radiohead — Paranoid Android
  { id: "n-rh-pa-1", trackId: "radiohead-paranoid-android", timestampSec: 77, durationMs: 6000, text: "Paranoid Android was stitched from three unfinished songs — the band called it their 'Bohemian Rhapsody, but angry.'", kind: "artist", sourceId: "src-rh-pa-yt" },
  { id: "n-rh-pa-2", trackId: "radiohead-paranoid-android", timestampSec: 193, durationMs: 5500, text: "EMI refused to release it as a single — at 6:23, radio wouldn't play it. Radiohead insisted and it became their signature.", kind: "track", sourceId: "src-rh-pa-art" },
  { id: "n-rh-pa-3", trackId: "radiohead-paranoid-android", timestampSec: 309, durationMs: 6000, text: "🎧 Listen for the savage guitar attack — Jonny Greenwood played it so hard his fingers bled on the fretboard.", kind: "discovery", listenFor: true, relatedMomentSec: 314, sourceId: "src-rh-pa-int" },
  // Radiohead — Reckoner
  { id: "n-rh-re-1", trackId: "radiohead-reckoner", timestampSec: 58, durationMs: 6000, text: "The original Reckoner was a thrashing rock song from 2001 — this gentle version took 6 years to emerge.", kind: "artist", sourceId: "src-rh-re-yt" },
  { id: "n-rh-re-2", trackId: "radiohead-reckoner", timestampSec: 145, durationMs: 5500, text: "In Rainbows was released as pay-what-you-want — the average payment was about £4, but it outsold their previous album.", kind: "track", sourceId: "src-rh-re-art" },
  { id: "n-rh-re-3", trackId: "radiohead-reckoner", timestampSec: 232, durationMs: 6000, text: "🎧 Listen for those shimmering guitar harmonics — Ed O'Brien stumbled on them accidentally and Thom said 'keep doing that forever.'", kind: "discovery", listenFor: true, relatedMomentSec: 237, sourceId: "src-rh-re-int" },
  // Pink Floyd — Shine On You Crazy Diamond
  { id: "n-pf-sh-1", trackId: "pink-floyd-shine-on", timestampSec: 103, durationMs: 6000, text: "The iconic four-note guitar motif was Gilmour's first take — he played it once and the band knew instantly.", kind: "artist", sourceId: "src-pf-sh-yt" },
  { id: "n-pf-sh-2", trackId: "pink-floyd-shine-on", timestampSec: 258, durationMs: 5500, text: "During recording, a bloated stranger walked into the studio. Nobody recognized him — it was Syd Barrett.", kind: "track", sourceId: "src-pf-sh-art" },
  { id: "n-pf-sh-3", trackId: "pink-floyd-shine-on", timestampSec: 413, durationMs: 6000, text: "🎧 Listen for the synth wash building here — Wright's keyboard parts were a 'cathedral of sound' for their lost friend.", kind: "discovery", listenFor: true, relatedMomentSec: 418, sourceId: "src-pf-sh-int" },
  // Pink Floyd — Comfortably Numb
  { id: "n-pf-cn-1", trackId: "pink-floyd-comfortably-numb", timestampSec: 76, durationMs: 6000, text: "Waters wrote the lyrics about a childhood fever; Gilmour's music came from a completely separate demo — they barely spoke while making it.", kind: "artist", sourceId: "src-pf-cn-yt" },
  { id: "n-pf-cn-2", trackId: "pink-floyd-comfortably-numb", timestampSec: 191, durationMs: 5500, text: "The band was so fractured during The Wall sessions that an inflatable wall literally separated them in the studio.", kind: "track", sourceId: "src-pf-cn-art" },
  { id: "n-pf-cn-3", trackId: "pink-floyd-comfortably-numb", timestampSec: 306, durationMs: 6000, text: "🎧 Listen for the second guitar solo — Gilmour recorded several takes, but the first was always the one. 'I just closed my eyes and played.'", kind: "discovery", listenFor: true, relatedMomentSec: 311, sourceId: "src-pf-cn-int" },
  // Björk — Jóga
  { id: "n-bj-jo-1", trackId: "bjork-joga", timestampSec: 61, durationMs: 6000, text: "The string arrangements were inspired by Iceland's tectonic plates — Björk wanted the music to sound like 'the earth splitting open.'", kind: "artist", sourceId: "src-bj-jo-yt" },
  { id: "n-bj-jo-2", trackId: "bjork-joga", timestampSec: 152, durationMs: 5500, text: "Jóga is a love letter to Iceland itself — the landscape isn't a metaphor, it IS the melody.", kind: "track", sourceId: "src-bj-jo-art" },
  { id: "n-bj-jo-3", trackId: "bjork-joga", timestampSec: 244, durationMs: 6000, text: "🎧 Listen for the beat drop with those massive strings — Björk wanted 'volcanoes and glaciers at the same time.'", kind: "discovery", listenFor: true, relatedMomentSec: 249, sourceId: "src-bj-jo-int" },
  // Kraftwerk — Trans-Europe Express
  { id: "n-kw-te-1", trackId: "kraftwerk-tee", timestampSec: 81, durationMs: 6000, text: "Afrika Bambaataa sampled this track for Planet Rock — accidentally inventing electro and launching hip-hop into the electronic age.", kind: "artist", sourceId: "src-kw-te-yt" },
  { id: "n-kw-te-2", trackId: "kraftwerk-tee", timestampSec: 203, durationMs: 5500, text: "The train rhythm was a sequencer accident — the tempo drifted and they decided the imperfection was the song.", kind: "track", sourceId: "src-kw-te-art" },
  { id: "n-kw-te-3", trackId: "kraftwerk-tee", timestampSec: 326, durationMs: 6000, text: "🎧 Listen for that hypnotic pulse — Hütter said 'we traveled by train across Europe. The rhythm of the rails became the song.'", kind: "discovery", listenFor: true, relatedMomentSec: 331, sourceId: "src-kw-te-int" },
  // David Bowie — Ziggy Stardust
  { id: "n-db-zi-1", trackId: "david-bowie-ziggy", timestampSec: 39, durationMs: 6000, text: "Ziggy was a composite of Iggy Pop, Vince Taylor, and a Japanese fashion designer — Bowie fused them into rock's greatest character.", kind: "artist", sourceId: "src-db-zi-yt" },
  { id: "n-db-zi-2", trackId: "david-bowie-ziggy", timestampSec: 97, durationMs: 5500, text: "Bowie became so consumed by Ziggy that friends said they couldn't tell where the character ended and David began.", kind: "track", sourceId: "src-db-zi-art" },
  { id: "n-db-zi-3", trackId: "david-bowie-ziggy", timestampSec: 155, durationMs: 6000, text: "🎧 Listen for Mick Ronson's guitar tone — he said 'David would show up as himself. By the second take, he was Ziggy.'", kind: "discovery", listenFor: true, relatedMomentSec: 160, sourceId: "src-db-zi-int" },
  // Ryuichi Sakamoto — Merry Christmas Mr. Lawrence
  { id: "n-rs-mcml-1", trackId: "sakamoto-mcml", timestampSec: 57, durationMs: 6000, text: "Sakamoto composed this theme in a single night — a simple repeating arpeggio that became one of the most recognized piano pieces of the century.", kind: "artist", sourceId: "src-rs-mcml-yt" },
  { id: "n-rs-mcml-2", trackId: "sakamoto-mcml", timestampSec: 142, durationMs: 5500, text: "Oshima told Sakamoto: 'You are the score.' He had to act in the film and compose it simultaneously.", kind: "track", sourceId: "src-rs-mcml-int" },
  { id: "n-rs-mcml-3", trackId: "sakamoto-mcml", timestampSec: 228, durationMs: 6000, text: "🎧 Listen for how the melody builds through repetition — Sakamoto almost didn't write it, calling the theme 'too simple.'", kind: "discovery", listenFor: true, relatedMomentSec: 233, sourceId: "src-rs-mcml-art" },
  // Ryuichi Sakamoto — andata
  { id: "n-rs-an-1", trackId: "sakamoto-andata", timestampSec: 68, durationMs: 6000, text: "async was composed during Sakamoto's recovery from throat cancer — each sound chosen as if it might be his last.", kind: "artist", sourceId: "src-rs-an-yt" },
  { id: "n-rs-an-2", trackId: "sakamoto-andata", timestampSec: 170, durationMs: 5500, text: "He recorded rain, wind, and the hum of empty rooms — nature became his primary collaborator on async.", kind: "track", sourceId: "src-rs-an-art" },
  { id: "n-rs-an-3", trackId: "sakamoto-andata", timestampSec: 272, durationMs: 6000, text: "🎧 Listen for the silence between notes — Sakamoto said 'I wanted to make the sound of a world without me in it.'", kind: "discovery", listenFor: true, relatedMomentSec: 277, sourceId: "src-rs-an-int" },
  // Moe Shop — Love Taste
  { id: "n-ms-lt-1", trackId: "moe-shop-love-taste", timestampSec: 35, durationMs: 6000, text: "Love Taste started as a SoundCloud upload that went viral — it defined the future funk sound for a generation of online listeners.", kind: "artist", sourceId: "src-ms-lt-yt" },
  { id: "n-ms-lt-2", trackId: "moe-shop-love-taste", timestampSec: 88, durationMs: 5500, text: "Moe Shop fuses 80s city pop, French house, and anime aesthetics into what they call 'pure serotonin.'", kind: "track", sourceId: "src-ms-lt-art" },
  { id: "n-ms-lt-3", trackId: "moe-shop-love-taste", timestampSec: 141, durationMs: 6000, text: "🎧 Listen for the vocal chop breakdown — Moe Shop wanted 'something that sounds like falling in love in a convenience store at 2 AM.'", kind: "discovery", listenFor: true, relatedMomentSec: 146, sourceId: "src-ms-lt-int" },
  // Moe Shop — Baby Pink
  { id: "n-ms-bp-1", trackId: "moe-shop-baby-pink", timestampSec: 40, durationMs: 6000, text: "YUC'e's vocals are pitched and re-sequenced until the human voice becomes a synthesizer — kawaii bass at its most inventive.", kind: "artist", sourceId: "src-ms-bp-yt" },
  { id: "n-ms-bp-2", trackId: "moe-shop-baby-pink", timestampSec: 99, durationMs: 5500, text: "Kawaii bass is 'aggressively cute — and somehow that makes it hit harder.' Baby Pink is the genre's thesis statement.", kind: "track", sourceId: "src-ms-bp-art" },
  { id: "n-ms-bp-3", trackId: "moe-shop-baby-pink", timestampSec: 158, durationMs: 6000, text: "🎧 Listen for that bouncy bass drop — every track on Moe Moe 'started as a joke. Then the jokes got really good.'", kind: "discovery", listenFor: true, relatedMomentSec: 163, sourceId: "src-ms-bp-int" },
  // Pete Rango — OFF THE LEASH
  { id: "n-pr-ot-1", trackId: "pete-rango-off-the-leash", timestampSec: 36, durationMs: 6000, text: "Pete Rango produced this track for LIL LIL under XUE Records — his production blends hard-hitting hip-hop with atmospheric textures.", kind: "artist", sourceId: "src-pr-ot-yt" },
  { id: "n-pr-ot-2", trackId: "pete-rango-off-the-leash", timestampSec: 91, durationMs: 5500, text: "Beyond producing, Rango has collaborated with DJ Jazzy Jeff, A$AP Ferg, and Kodak Black over a decade-long career.", kind: "track", sourceId: "src-pr-ot-art" },
  { id: "n-pr-ot-3", trackId: "pete-rango-off-the-leash", timestampSec: 146, durationMs: 6000, text: "🎧 Listen for the production layers — Rango also runs Dream Labs, teaching music production to students in Petersburg, VA.", kind: "discovery", listenFor: true, relatedMomentSec: 151, sourceId: "src-pr-ot-int" },
  // Jamee Cornelia — Husky
  { id: "n-jc-hu-1", trackId: "jamee-cornelia-husky", timestampSec: 39, durationMs: 6000, text: "The Husky video was self-directed on a shoestring budget — Cornelia edited it alone, staying true to the DIY ethos.", kind: "artist", sourceId: "src-jc-hu-yt" },
  { id: "n-jc-hu-2", trackId: "jamee-cornelia-husky", timestampSec: 97, durationMs: 5500, text: "Cornelia makes music that 'sounds like a conversation with yourself at 3 AM' — raw, unfiltered, and uncomfortably honest.", kind: "track", sourceId: "src-jc-hu-art" },
  { id: "n-jc-hu-3", trackId: "jamee-cornelia-husky", timestampSec: 156, durationMs: 6000, text: "🎧 Listen for the flow shift here — Cornelia says 'I rap because I have to. It's cheaper than therapy and more honest than a journal.'", kind: "discovery", listenFor: true, relatedMomentSec: 161, sourceId: "src-jc-hu-int" },
  // Jamee Cornelia — Routine
  { id: "n-jc-ro-1", trackId: "jamee-cornelia-routine", timestampSec: 42, durationMs: 6000, text: "Art School Dropout was recorded in bedrooms and basements across Atlanta — the lo-fi sound isn't a limitation, it's a statement.", kind: "artist", sourceId: "src-jc-ro-yt" },
  { id: "n-jc-ro-2", trackId: "jamee-cornelia-routine", timestampSec: 105, durationMs: 5500, text: "Cornelia treats albums like art exhibitions — each track is a different room in the same building.", kind: "track", sourceId: "src-jc-ro-art" },
  { id: "n-jc-ro-3", trackId: "jamee-cornelia-routine", timestampSec: 168, durationMs: 6000, text: "🎧 Listen for the beat switch — Cornelia says 'I dropped out to make the art they said I couldn't. This album is the receipt.'", kind: "discovery", listenFor: true, relatedMomentSec: 173, sourceId: "src-jc-ro-int" },
];
